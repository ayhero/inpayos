...
// @Failure 401 {object} protocol.Result "认证失败"
// @Failure 500 {object} protocol.Result "服务器错误"
// @Router /openapi/checkout/submit [post]
func (a *OpenApi) SubmitCheckout(c *gin.Context) {
	lang := middleware.GetLanguage(c)
...
// @Failure 401 {object} protocol.Result "认证失败"
// @Failure 500 {object} protocol.Result "服务器错误"
// @Router /openapi/checkout/services [get]
func (a *OpenApi) CheckoutServices(c *gin.Context) {
	...
	// 执行业务逻辑
	response, code := a.Checkout.ListServices(checkoutID)
	result := protocol.HandleServiceResult(code, response, lang)
	c.JSON(http.StatusOK, result)
}
...
// @Failure 401 {object} protocol.Result "认证失败"
// @Failure 500 {object} protocol.Result "服务器错误"
// @Router /openapi/checkout/confirm [post]
...
// @Failure 401 {object} protocol.Result "认证失败"
// @Failure 500 {object} protocol.Result "服务器错误"
// @Router /openapi/checkout/info [get]
func (a *OpenApi) CheckoutInfo(c *gin.Context) {
	checkoutID := c.Query("checkout_id")
	lang := middleware.GetLanguage(c)
	if checkoutID == "" {
		c.JSON(http.StatusOK, protocol.NewErrorResultWithCode(protocol.MissingParams, lang))
...
// @Failure 401 {object} protocol.Result "认证失败"
// @Failure 500 {object} protocol.Result "服务器错误"
// @Router /openapi/checkout/cancel [post]
